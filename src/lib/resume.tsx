...
export const projectsData = [
  {
    ...
    description:
      " Revolutionize entertainment with our cutting-edge React.js-based OTT Platform, For infinite scroll, the combination of React and vite allows for the implementation of smooth and efficient infinite scrolling. OTT Platform is Fully Responsive for all Screen-Size.",
    image: "/carsoul-1.png",
    tag: ["All", "Web"],
  ...
  },
  {
    ...
    previewUrl:
      "https://64d89c95f606f97b4bfbc2e3--papaya-licorice-467ef3.netlify.app/",
  },

  {
    ...
    gitUrl: "/",
    previewUrl:
      "https://64b7fab71872d12250a34819--gregarious-semifreddo-588bc8.netlify.app/",
  },
  {
    id: 4,
    title: "Extractify PDF",
    description:
      "ExtractifyPDF, is a groundbreaking tool designed to effortlessly extract valuable content from PDF documents.With ExtractifyPDF, users can seamlessly extract desired pages from big pdf.",
  ...
  },
  {
    ...
    gitUrl: "/",
    previewUrl:
      "https://64aad3cb2211463cf72514cd--creative-cupcake-bb54c5.netlify.app/",
  },
  {
    id: 6,
    title: "ATS(Smart Resume Analyzer)",
    description:
      "Basically our aim is to ease the recruitment process. The process will provide the quality of applicants for the companies",
    image: "/ATS.jpg",
    tag: ["All", "Web"],
  ...
  },
  {
    ...
    description:
      "Describes the advantages of using OpenCV, especially the Ad boost algorithm, in the process of face recognition. Detecting and recognition of face in complicated color images can be achieved using a combination of a particular algorithm",
...
export const experienceData = [
  ...
  {
    title: "Jio",
    duration: "DevOps | Jan 2024 - Present ",
    ...
    Developed and deployed Python scripts to automate repetitive tasks and execute complex Linux commands for server management 
    and network diagnostics on Production servers. Performed data extraction and analysis from MySQL databases, fetching critical 
    node details and alarm data to ensure optimal system performance and availability. Monitored and validated node status using Zabbix
    and managed real-time alerts via JAM (Alarm Management System) for node availability, Leveraged DaaS and Accops for technical 
    operations.`,
  },
  {
    title: "EMSEC.Pvt (Bristol, England) ",
    duration: "SDE | Feb-Dec 2023",
    description: ` Worked on the Shodan’s Clone and Breachwise Development. It's a Hacker's search engine that let’s users search for various types 
of servers connected to the internet using a variety of filters. We are using MERN Stack technology to build this project. 
Documentation of Shodan created by myself.`,
  },
  {
    title: " Azure Skynet Solutions Pvt.Ltd",
    duration: "Web Developer | May-June 2021",
    description:
      "Developing and maintaining web applications using Javascript, HTML, CSS, and other related technologies. Acquired solid knowledge of JavaScript, HTML, CSS, and React Js for front-end web development. Demonstrated proficiency in JavaScript and React, optimizing code for improved performance in scalable web applications. Implementing responsive design and ensuring cross-browser compatibility.",
  },
  {
    title: "Youtube",
    duration: " Techy Satyam | March 2019 - Present ",
    description:
      "	Helping students to learn about the latest technology,. Utilized effective SEO strategies to optimize video titles, descriptions, and tags, resulting in increased discoverability and organic growth.",
  },
];
